...
export function isDayOff(date, scaleType, referenceDateStr = '06/10/2025') {
  ...
  const referenceDate = new Date(Date.UTC(refYear, refMonth - 1, refDay)); // Mês é 0-indexado no JavaScript
  ...
  const dayOfWeekIndex = (date.getUTCDay() + 6) % 7; // Converte de Dom=0 para Seg=0
